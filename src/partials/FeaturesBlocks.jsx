      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">How Lottify Works</h2>
            <p className="text-xl text-gray-600">Lottify's Instagram Giveaway Tool allows businesses to randomly choose giveaway winners through their posts based on certain criteria.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <p className="text-gray-600 text-center">Save your account with us to prevent connecting to instagram every time.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Easy Connection</h4>
              <p className="text-gray-600 text-center">Easily grab the correct giveaway post with the post's URL.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Set Preferences</h4>
              <p className="text-gray-600 text-center">Effectively personalize your giveaway with our customizable settings.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Rapid Results</h4>
              <p className="text-gray-600 text-center">Get the giveaway results within a matter of seconds.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Save History</h4>
              <p className="text-gray-600 text-center">You can see past giveaway winners through your accounts history.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Unlimited Drawings</h4>
              <p className="text-gray-600 text-center">By signing up with Lottify you get access to unlimited giveaway potential.</p>
            </div>
